---
title: "Generación de Segmentos Geográficos para el Censo 2022 en áreas urbanas y suburbanas"
...
class: center, inverse background-image: url("plantilla_idera_html/img0.png")
...
Para asegurar que todas las viviendas sean censadas, hay que determinar área que deberá recorrer cada censista.
...
-   El segmento 90 y contiene las viviendas colectivas del radio.
...
Un problema de optimización, matemáticamente se formulan como: Min f(x) sujeto a: x Є S, donde S es el conjunto de los valores entre los que podemos buscar la solución, lo que se llama conjunto de soluciones factibles. 
