...
El optimo no es un valor, sino una función Estamos acostumbrados a considerar problemas de optimización, que matemáticamente se formulan como: Min f(x) sujeto a: x Є S Donde S es el conjunto de los valores entre los que podemos buscar la solución, lo que se llama conjunto de Factible, Desde el punto de vista matemático no existe ninguna diferencia entre que el problema sea de maximizar o de minimizar, pues el cambio se puede hacer .
