...
3. si no, es un la segmentación actual es un mínimo local, terminar.

------------------------------------------------------------------------

### Algoritmo para radios densos (manzanas independientes)

1. en cada manzana encontrar el número entero $d_m$ más cercano a cant_viv_m / cant_viv_deseada
2. hacer ese el número de segmentos en la manzana m
3. calcular cantidad de viviendas por segmento en manzana m $s_m = v_m / d_m$
4. cortar el listado de la manzana m cortando a piso enteros anavanzando con segmentos de cant. de viviendas lo más cercano a $s_m$ posible
...
2. para todos los componentes que superen un valor umbral de viviendas aplicar algoritmo de (listado) manzana independiente
