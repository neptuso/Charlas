...
output:
  ...
  beamer_presentation: 
    toc: yes
    incremental: yes
subtitle: "Generación de Segmentos Geográficos en áreas urbanas y suburbanas"
encoding: utf8
---

<!-- por acá empieza Vero la resentación -->

# Introducción {data-background-image="imagenes/cac-logo.png"}
...
## Preguntas {data-background-gradient="linear-gradient(to bottom, #283b95, #17b2c3)"}

### ?

## Contacto

Hernán halperin@indec.gob.ar

Verónica vheredia@indec.gob.ar 
