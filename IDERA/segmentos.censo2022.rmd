...
![](imagenes/optimizacion_discreta.png)
:::
...
2. Si su costo es menor que el costo de la segmentación actual, hacer ésta la nueva segmentación actual e iterar
...
* Creamos un intarface para la carga de datos y porcesamiento de la segmentacion
