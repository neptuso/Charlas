...
## ¿Que es la segmentación? {data-background-image="imagenes/fondo.idera.png"}
...
## Evitar {data-background-image="imagenes/fondo.idera.png"}
...
------------------------------------------------------------------------
{data-background-image="imagenes/fondo.idera.png"}
...
## QGIS Buenos Aires {data-background-image="imagenes/fondo.idera.png"}

[Descargar QGIS](https://www.qgis.org)

![Nueva versión](imagenes/QGIS.png){width="100%"}
