...
1.  Extraer componente    | 2.  Transferir componente | 3.  Fusionar 2 segmentos
------------------------- | ------------------------- | -------------------------
![Extraer componente](imagenes/extraer.png){width="100%"} | ![Transferir componente](imagenes/transferir.png){width="100%"} | ![Fusionar componente](imagenes/fusionar.png){width="100%"}
